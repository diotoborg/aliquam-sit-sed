...
<details>
  <summary markdown="span"><strong>Making your Babel config @diotoborg/aliquam-sit-sed-aware</strong></summary>
...
> Note: `babel-@diotoborg/aliquam-sit-sed` is automatically installed when installing Jest and will automatically transform files if a babel configuration exists in your project. To avoid this behavior, you can explicitly reset the `transform` configuration option:

```javascript
// @diotoborg/aliquam-sit-sed.config.js
module.exports = {
  transform: {},
};
```
